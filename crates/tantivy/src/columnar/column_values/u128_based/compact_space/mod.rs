...
use crate::bitpacker::{BitPacker, BitUnpacker};
use crate::common::{BinarySerializable, CountingWriter, OwnedBytes, VInt, VIntU128};
use build_compact_space::get_compact_space;

use crate::columnar::column_values::ColumnValues;
...
impl CompactSpaceCompressor {
    ...
    pub fn train_from(iter: impl Iterator<Item = u128>) -> Self {
        ...
        let num_bits = crate::bitpacker::compute_num_bits(amplitude_compact_space as u64);
...
mod tests {
    ...
    use super::*;
    use crate::columnar::column_values::u128_based::U128Header;
    use crate::columnar::column_values::{open_u128_mapped, serialize_column_values_u128};
