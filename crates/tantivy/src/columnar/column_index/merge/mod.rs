...
use crate::columnar::{Cardinality, ColumnIndex, MergeRowOrder};
...
#[cfg(test)]
mod tests {
    use crate::columnar::column_index::merge::detect_cardinality;
    use crate::columnar::column_index::multivalued_index::MultiValueIndex;
    use crate::columnar::column_index::{
        merge_column_index, OptionalIndex, SerializableColumnIndex,
    };
    use crate::columnar::{
