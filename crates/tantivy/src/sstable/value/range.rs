...
use crate::sstable::value::{deserialize_vint_u64, ValueReader, ValueWriter};
...
impl ValueWriter for RangeValueWriter {
    ...
    fn serialize_block(&self, writer: &mut Vec<u8>) {
        ...
        crate::sstable::vint::serialize_into_vec(self.vals.len() as u64, writer);
        for &val in &self.vals {
            let delta = val - prev_val;
            crate::sstable::vint::serialize_into_vec(delta, writer);
            prev_val = val;
        }
    }
