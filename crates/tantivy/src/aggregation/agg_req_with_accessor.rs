...
use crate::columnar::{Column, ColumnBlockAccessor, ColumnType, DynamicColumn, StrColumn};
...
) -> crate::Result<(crate::columnar::Column<u64>, ColumnType)> {
...
fn get_dynamic_columns(
    reader: &SegmentReader,
    field_name: &str,
) -> crate::Result<Vec<crate::columnar::DynamicColumn>> {
...
) -> crate::Result<Vec<(crate::columnar::Column<u64>, ColumnType)>> {
    let ff_fields = reader.fast_fields();
