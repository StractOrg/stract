...
use crate::columnar::{Column, ColumnType, ColumnarReader, DynamicColumn};
use crate::common::json_path_writer::JSON_PATH_SEGMENT_SEP_STR;
    ...
    fn test_aggregation_top_hits(merge_segments: bool) -> crate::Result<()> {
        ...
        assert_eq!(
            ...
            json!({
                "hits": [
                    {
                        "sort": [crate::common::i64_to_u64(date_2017.unix_timestamp_nanos() as i64)],
                        "docvalue_fields": {
                    ...
                    {
                        "sort": [crate::common::i64_to_u64(date_2016.unix_timestamp_nanos() as i64)],
                        "docvalue_fields": {
