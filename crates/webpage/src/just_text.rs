...
static STOPWORDS: once_cell::sync::Lazy<HashMap<Lang, HashSet<String>>> =
    once_cell::sync::Lazy::new(|| {
        include_stopwords!(
                "../../core/stopwords/Afrikaans.txt" => Lang::Afr,
                "../../core/stopwords/Arabic.txt" => Lang::Ara,
                "../../core/stopwords/Armenian.txt" => Lang::Hye,
                "../../core/stopwords/Azerbaijani.txt" => Lang::Aze,
                "../../core/stopwords/Belarusian.txt" => Lang::Bel,
                "../../core/stopwords/Bengali.txt" => Lang::Ben,
                "../../core/stopwords/Bulgarian.txt" => Lang::Bul,
                "../../core/stopwords/Catalan.txt" => Lang::Cat,
                "../../core/stopwords/Croatian.txt" => Lang::Hrv,
                "../../core/stopwords/Czech.txt" => Lang::Ces,
                "../../core/stopwords/Danish.txt" => Lang::Dan,
                "../../core/stopwords/Dutch.txt" => Lang::Nld,
                "../../core/stopwords/English.txt" => Lang::Eng,
                "../../core/stopwords/Esperanto.txt" => Lang::Epo,
                "../../core/stopwords/Estonian.txt" => Lang::Est,
                "../../core/stopwords/Finnish.txt" => Lang::Fin,
                "../../core/stopwords/French.txt" => Lang::Fra,
                "../../core/stopwords/Georgian.txt" => Lang::Kat,
                "../../core/stopwords/German.txt" => Lang::Deu,
                "../../core/stopwords/Greek.txt" => Lang::Ell,
                "../../core/stopwords/Gujarati.txt" => Lang::Guj,
                "../../core/stopwords/Hebrew.txt" => Lang::Heb,
                "../../core/stopwords/Hindi.txt" => Lang::Hin,
                "../../core/stopwords/Hungarian.txt" => Lang::Hun,
                "../../core/stopwords/Indonesian.txt" => Lang::Ind,
                "../../core/stopwords/Italian.txt" => Lang::Ita,
                "../../core/stopwords/Javanese.txt" => Lang::Jav,
                "../../core/stopwords/Kannada.txt" => Lang::Kan,
                "../../core/stopwords/Korean.txt" => Lang::Kor,
                "../../core/stopwords/Latin.txt" => Lang::Lat,
                "../../core/stopwords/Latvian.txt" => Lang::Lav,
                "../../core/stopwords/Lithuanian.txt" => Lang::Lit,
                "../../core/stopwords/Macedonian.txt" => Lang::Mkd,
                "../../core/stopwords/Malayalam.txt" => Lang::Mal,
                "../../core/stopwords/Marathi.txt" => Lang::Mar,
                "../../core/stopwords/Nepali.txt" => Lang::Nep,
                "../../core/stopwords/Persian.txt" => Lang::Pes,
                "../../core/stopwords/Polish.txt" => Lang::Pol,
                "../../core/stopwords/Portuguese.txt" => Lang::Por,
                "../../core/stopwords/Romanian.txt" => Lang::Ron,
                "../../core/stopwords/Russian.txt" => Lang::Rus,
                "../../core/stopwords/Serbian.txt" => Lang::Srp,
                "../../core/stopwords/Slovak.txt" => Lang::Slk,
                "../../core/stopwords/Slovenian.txt" => Lang::Slv,
                "../../core/stopwords/Spanish.txt" => Lang::Spa,
                "../../core/stopwords/Japanese.txt" => Lang::Jpn
        )
    });
