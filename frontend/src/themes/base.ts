...
export const theme = (opts: ThemeOpts) => {
  ...
  const colors: Required<Colors> = {
    ...
    base200: opts.colors?.base200 ?? focus(opts.colors.base100),
    base300: opts.colors?.base300 ?? focus(focus(opts.colors.base100)),
    base400: opts.colors?.base400 ?? focus(focus(focus(opts.colors.base100))),
